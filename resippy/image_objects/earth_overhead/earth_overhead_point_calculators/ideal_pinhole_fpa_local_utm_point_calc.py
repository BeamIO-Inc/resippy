...
from resippy.image_objects.earth_overhead.earth_overhead_point_calculators.supporting_classes.pinhole_camera import \
    PinholeCamera
from resippy.image_objects.earth_overhead.earth_overhead_point_calculators.abstract_earth_overhead_point_calc import \
    AbstractEarthOverheadPointCalc
...
class IdealPinholeFpaLocalUtmPointCalc(AbstractEarthOverheadPointCalc):
    ...
    def image_plane_coords_to_pixel_coords(self,
        ...
        fpa_coords_pixels_x = (
                                      fpa_coords_meters_x + half_fpa_x_meters - self._pixel_pitch_x_meters / 2) / self._pixel_pitch_x_meters
        fpa_coords_pixels_y = (
                                      fpa_coords_meters_y + half_fpa_y_meters - self._pixel_pitch_y_meters / 2) / self._pixel_pitch_y_meters
    ...
    @classmethod
    def init_from_wgs84_params_and_m_matrix(cls,
        ...
        pinhole_camera.init_pinhole_from_m_matrix(sensor_x_local,
                                                  sensor_y_local,
                                                  sensor_altitude,
                                                  m_matrix,
                                                  focal_length,
    ...
    @classmethod
    def init_from_wgs84_params_and_roll_pitch_yaw(cls,
                                                  sensor_lon_decimal_degrees,  # type: float
                                                  sensor_lat_decimal_degrees,  # type: float
                                                  sensor_altitude,  # type: float
                                                  omega,  # type: float
    ...
    @classmethod
    def init_from_local_params_and_m_matrix(cls,
        ...
        pinhole_camera = PinholeCamera()
        pinhole_camera.init_pinhole_from_m_matrix(sensor_lon,
                                                  sensor_lat,
                                                  sensor_altitude,
                                                  m_matrix,
                                                  focal_length,
    ...
    @classmethod
    def init_from_local_params_and_roll_pitch_yaw(cls,
                                                  sensor_lon,  # type: float
                                                  sensor_lat,  # type: float
                                                  sensor_altitude,  # type: float
                                                  native_proj,  # type: Proj
